...
class TestCompressor(unittest.TestCase):
    def setUp(self):
        self.lz_mock = Mock()
        self.lz_decompressor_mock = Mock()
        self.huff_mock = Mock()
        ...
        self.compressor = Compressor(self.lz_mock, self.lz_decompressor_mock, self.huff_mock,
                                     self.huff_decompressor_mock, FakeFileIO())
    ...
    def test_compressor_calls_lz_decompress_when_lz_selected(self):
        ...
        self.lz_decompressor_mock.decompress.assert_called_with(
            b"\x00\x00\x00S{'t': '000', 'l': '001', 'e': '010', ' ': '011', 'o': '100', 'H': '101', 's': '11'}\x01\xa8\x98\xc2\xc6")
